...
public class Seleniumhw2{
	public static void main(String[] args) {
		...
		WebElement change = driver.findElement(By.id("updateLeadForm_description"));
		change.clear();
		//important not update
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("lead is updated through automation");
		
		//submit the update button
